...
<div class="flex h-screen overflow-hidden" x-data="{ sidebarOpen: false }">
    ...
    {{-- Sidebar --}}
    <aside class="fixed inset-y-0 left-0 z-30 flex flex-col w-64 bg-primary-950 text-white flex-shrink-0 transform transition-transform duration-300 ease-in-out lg:relative lg:translate-x-0"
